    ...
    <body>
        ...
        <div class="main-content">
            <form id="main-form" autocomplete="off" class="form-basic" method="post" enctype="multipart/form-data"
                ...
                <div class="form-row">
                    <label>
                        <span>Please Upload the file in csv format </span>
                        <input type="file" name="file" accept=".csv" autocomplete="off" autofocus title="Please upload .xlsx file" required/>
        ...
        <form id="main-form" autocomplete="off" class="form-basic" method="post" enctype="multipart/form-data"
                ...
                <div class="form-row">
                    <label>
                        ...
                        <input type="file" name="file" accept=".xml" autocomplete="off" autofocus title="Please upload .xml file" required/>
